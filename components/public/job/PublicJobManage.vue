          ...
          <div class="w-100 d-flex flex-column p-8">
            ...
            <div class="vacancy_text2 pt-3">
              <h5 class="font-weight-light">
                ...
                ценовая политика также благоприятствует развитию партнерских отношений.
              </h5>
            </div>
          </div>
          <div class="w-100 bg-dark d-flex flex-column text-white p-8">
            ...
            <div class="d-flex flex-row pt-5 pb-5">
              ...
              <div class="d-flex flex-column">
                ...
                <div class="vacancy_right_text pt-3"><h5 class="font-weight-light">+7 (800) 301-62-98</h5></div>
              </div>
            </div>
            <div class="pt-3">
