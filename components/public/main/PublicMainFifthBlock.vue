<template>
  <div class="d-flex flex-column flex-lg-row shadow">
    <div class="d-flex flex-column block5 te" style="padding: 50px">
      <p class="block5_header mb-5">Мы находимся</p>
      <p class="block5_heading">Адрес:</p>
      <p class="text-truncate mb-5">г. Екатеринбург, ул. Радищева, д.4, оф.661</p>
      <p class="block5_heading">Телефон:</p>
      <span class="mb-1">+7 (906) 812-81-75</span>
